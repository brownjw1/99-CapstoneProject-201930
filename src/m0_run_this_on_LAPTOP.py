"""
  ...
  Authors:  Your professors (for the framework)
    and Jared Brown, Micah Fletcher, Maria Bruner.
...
def main():
    ...
    # -------------------------------------------------------------------------
    root = tkinter.Tk()
    root.title("Team 09: Jared Brown, Micah Fletcher and Maria Bruner")
    ...
    mqtt_sender.connect_to_ev3(lego_robot_number=9)
